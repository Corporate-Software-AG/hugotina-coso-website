...
for (let l of links) {
  if (l.href.startsWith("http") && !l.href.startsWith("http://localhost:1313") && !l.href.startsWith("https://www.corporatesoftware.ch") && !l.href.startsWith("https://happy-hill-0bae78803.4.azurestaticapps.net")) {
    l.target = "_blank"
  }
}
